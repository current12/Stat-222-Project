...
# Load Model
predictor = TabularPredictor.load(os.path.expanduser('~/Box/STAT 222 Capstone/Autogluon/Autogluon_Tabular_Only_Best_Presets_SCF'))
print(predictor)
...
# Save to Excel
predictions.to_excel('../../../../Data/Predictions/Autogluon/Autogluon_Tabular_Only_SCF_Best_Presets_predictions.xlsx', index=False)
print(predictions)
...
# Save to Excel
leaderboard.to_excel('../../../../Output/Modelling/Autogluon/Autogluon_Tabular_Only_SCF_Best_Presets_leaderboard.xlsx', index=False)
print(leaderboard)
...
# Save to Excel
hyperparameters_df.to_excel('../../../../Output/Modelling/Autogluon/Autogluon_Tabular_Only_SCF_Best_Presets_hyperparameters.xlsx', index=False)
...
# Save to Excel
fi.to_excel('../../../../Output/Modelling/Autogluon/Autogluon_Tabular_Only_SCF_Best_Presets_feature_importance.xlsx', index=True)
