...
def parse_args():
    ...
    parser.add_argument("--inductive", type=lambda x: (str(x).lower() in ['true', '1']), default=False,
        help='whether to train gnn inductively')
    ...
    pd.DataFrame.from_dict(
        {
            ...
            'pred_proba_class_1': y_pred_prob[:, 1], # estimated probabilites of class label 1
...
if __name__ == '__main__':
    ...
    args = parse_args()
    inductive_entry_train(training_dir = args.training_dir,
                            model_dir = args.model_dir,
                            output_dir = args.output_dir,
                            features_train = args.features_train,
                            features_test = args.features_test,
                            target_column = args.target_column,
                            source_destination_node_index = args.source_destination_node_index,
